...
Thumbor.prototype = {
  ...
  buildUrl: async function() {
    ...
    if (this.THUMBOR_SECURITY_KEY) {
      ...
      var base64 = btoa(hashHex.match(/\w{2}/g).map(function(a){return String.fromCharCode(parseInt(a, 16));} ).join(""))
      var key = base64.replace(/\+/g, '-').replace(/\//g, '_');
